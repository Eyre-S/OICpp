 ...
 * 作者：追忆。似海 <https://www.luogu.org/user/25029>
 * 可读性优化：Cookie Sukazyo Eyre
 * 
 * 使用算法：倍增
 * 
 */
...
int first[maxn], next____[2*maxn];   //同理； 
...
//    freopen("in2.txt","r",stdin);
    ...
    memset(next____,-1,sizeof(next____));
    int s,t;
    int dsd=2*(n-1);
